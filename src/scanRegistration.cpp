...
// sensor_msgs::PointCloud2Ptr rosMultiLaserScanToPointCloud2(const sensor_msgs::MultiEchoLaserScan &scan)
// {
//   sensor_msgs::LaserScanPtr laser_scan = laser_proc::LaserProc::getFirstScan(scan);
//   laser_geometry::LaserProjection projector;
//   sensor_msgs::PointCloud2Ptr cloud_msg;
//   projector.projectLaser(*laser_scan, *cloud_msg, -1);
//   return cloud_msg;
// }
...
{
  // sensor_msgs::PointCloud2Ptr laserCloudIn2 = rosMultiLaserScanToPointCloud2(laserScan);
  ...
  for (int i = 0; i < cloudInSize; i++) {
    ...
    ROS_INFO_STREAM("end_if " << cloudSize);
  }
